    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('admin/services/'.$service->id.'/update')}}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="nameComp" name="nameComp" class="form-control" value="{{$service->nameComp}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="responsible" name="responsible" class="form-control" value="{{$service->responsibleComp}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="phone" name="phone" class="form-control" value="{{$service->phoneComp}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="address" name="address" class="form-control" value="{{$service->	addressComp}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="city" name="city" class="form-control" value="{{$service->cityComp}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="iniServ" name="iniServ" class="form-control" data-toggle="datepicker" value="{{\Carbon\Carbon::parse($service->iniDateService)->format('d/m/Y')}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="endServ" name="endServ" class="form-control" data-toggle="datepicker" value="{{\Carbon\Carbon::parse($service->endDateService)->format('d/m/Y')}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="type" name="type" class="form-control" value="{{$service->typeService}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="block" name="block" class="form-control" value="{{$service->block}}">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="selectpicker form-control" id="aptNumber" name="aptNumber">
                                            @foreach($users as $user)
                                                @if($user->aptNumber == $service->aptNumber)
                                                    <option value="{{$user->id}}" selected>{{$user->aptNumber}}</option>
                                                @else
