    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('admin/forum/'.$forum->id.'/update')}}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control" value="{{$forum->titleForum}}" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="date" name="date" class="form-control" value="{{\Carbon\Carbon::parse($forum->created_at)->format('d/m/Y')}}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea id="description" name="description" class="form-control">{{html_entity_decode($forum->descForum)}}</textarea>
