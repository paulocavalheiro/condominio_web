...
return [
    ...
    */
    ...
    | convenção "attribute.rule" para nomear as linhas. Isso nos ajuda a tornar as mensagens um pouco mais limpas.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar marcadores de posição de atributos
    | por algo mais amigável ao leitor, como Endereço de E-mail em vez de "email".
    | Isso simplesmente nos ajuda a fazer mensagens um pouco mais limpas.
    |
    */
